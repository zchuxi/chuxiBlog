...
export const resourceSchemas = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'categoryId', label: '分类 ID', type: 'number', group: '系统信息', hidden: true, tip: '按分类名自动维护，无需填写' },
      { name: 'category', label: '工具类型', type: 'select', allowCustom: true, group: '基本信息', required: true, options: ['AI 导航', 'AI 助手', '设计创作', '开发协作', '效率办公', '搜索研究'], tip: '选择已有类型，或选「自定义…」手动输入新类型' },
      { name: 'iconUrl', label: '图标', type: 'image', ratio: 1, group: '内容与媒体', tip: '用于列表图标，建议使用 1:1 方形图片' },
      { name: 'imageUrl', label: '展示图（详情页，横版 2:1）', type: 'image', ratio: 2 / 1, group: '内容与媒体', tip: '用于详情页展示，建议使用 2:1 横版图片' },
  ...
  },
  {
    ...
    fields: [
      { name: 'id', label: 'ID', type: 'number', group: '系统信息', tip: '由系统生成，编辑时仅供查看' },
      { name: 'title', label: '标题', type: 'text', group: '基本信息', required: true },
      { name: 'tag', label: '标签', type: 'text', group: '基本信息', tip: '用于内容分类，请填写一个简短标签' },
      { name: 'content', label: '内容', type: 'textarea', group: '内容与媒体', required: true },
      { name: 'summary', label: '摘要', type: 'textarea', group: '内容与媒体' },
      { name: 'imageUrl', label: '配图', type: 'image', ratio: 16 / 10, group: '内容与媒体', tip: '用于内容封面，建议使用 16:10 横版图片' },
